...
def welcome(request):
    return render(request, 'esmartapp/welcome.html')

@login_required
def dashboard(request):
    return render(request, 'esmartapp/dashboard.html')
...
def user_register(request):
    ...
    return render(request, 'esmartapp/register.html',
...
def user_login(request):
    ...
    return render(request, 'esmartapp/login.html',
                  {'error_message': error_message})
